package com.vladimirpandurov.invoice_manager2_02.repository.implementation;
...
import com.vladimirpandurov.invoice_manager2_02.enumeration.VerificationType;
import com.vladimirpandurov.invoice_manager2_02.exception.ApiException;
...
import com.vladimirpandurov.invoice_manager2_02.rowmapper.UserRowMapper;
...
import static com.vladimirpandurov.invoice_manager2_02.enumeration.RoleType.ROLE_USER;
import static com.vladimirpandurov.invoice_manager2_02.enumeration.VerificationType.ACCOUNT;
import static com.vladimirpandurov.invoice_manager2_02.enumeration.VerificationType.PASSWORD;
import static com.vladimirpandurov.invoice_manager2_02.query.UserQuery.*;
...
public class UserRepositoryImpl implements UserRepository<User>, UserDetailsService {
    ...
    private static final String DATA_FORMAT = "yyyy-dd-mm hh:mm:ss";
    ...
    public void sendVerificationCode(UserDTO userDTO) {
        ...
        try{
            ...
            //sendSms()
            log.info("Phone number: {}, verification code : {}", userDTO.getPhone(), verificationCode);
        }catch (Exception exception){
            log.error(exception.getMessage());
            throw new ApiException("An error occurred. Please try again.");
        }
