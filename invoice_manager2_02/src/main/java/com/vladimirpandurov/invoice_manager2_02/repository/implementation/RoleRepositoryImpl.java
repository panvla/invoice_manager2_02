...
import com.vladimirpandurov.invoice_manager2_02.rowmapper.RoleRowMapper;
...
import static com.vladimirpandurov.invoice_manager2_02.query.RoleQuery.*;
...
public class RoleRepositoryImpl implements RoleRepository<Role> {
    ...
    public Role getRoleByUserId(Long userId) {
        try{
            ...
            throw new ApiException("An error occurred in getRoleByUserId in RoleRepository. Please try again");
        }
    }
