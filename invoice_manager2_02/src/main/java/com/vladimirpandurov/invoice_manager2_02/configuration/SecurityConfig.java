package com.vladimirpandurov.invoice_manager2_02.configuration;

import com.vladimirpandurov.invoice_manager2_02.filter.CustomAuthorizationFilter;
import com.vladimirpandurov.invoice_manager2_02.handler.CustomAccessDeniedHandler;
import com.vladimirpandurov.invoice_manager2_02.handler.CustomAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    private static final String[] PUBLIC_URLS = {"/user/login/**", "/user/register/**", "/user/verify/code/**", "/user/resetpassword/**",
